...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Movixa is a cinematic AI creative studio crafting commercials, CGI product ads, architectural transformations, logo animations, and AI films for world-class brands." },
      { name: "author", content: "Movixa" },
      { property: "og:title", content: "Movixa — Cinematic AI Creative Studio" },
      { property: "og:description", content: "AI commercials, CGI ads, product visualizations, and cinematic films crafted with obsessive detail." },
